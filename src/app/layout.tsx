...
export const metadata: Metadata = {
  ...
  description: "Windows 11・iPhone・iPad・Android・Macの設定方法とトラブル解決を検索。困りごとから最短手順へ案内します。",
  openGraph: {
    title: "設定どこ？ - 設定方法・トラブル解決ガイド",
    description: "設定場所がわからない、うまく動かない。Windows 11・iPhone・iPad・Android・Macの解決方法を検索できます。",
      ...
      <body>
        ...
        <footer className="site-footer no-print">
          <div className="site-footer-links">
            ...
            <Link href="/apps" style={{ color: "var(--text-muted)", textDecoration: "none" }}>アプリ・ブラウザ</Link>
            ...
            <Link href="/feature" style={{ color: "var(--text-muted)", textDecoration: "none" }}>特集</Link>
          ...
          <div className="site-footer-note">
            Windows 11 / iPhone・iPad / Android / macOS の設定・トラブル解決サービス
          </div>
        </footer>
      </body>
    </html>
