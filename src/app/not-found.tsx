...
export default function NotFound() {
  return (
    <div className="not-found-page" style={{ textAlign: "center", padding: "80px 20px 60px" }}>
      ...
      <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
        ...
        <Link href="/os/windows11" className="secondary-button" style={{
          padding: "12px 28px", borderRadius: 10,
      ...
      <div style={{ marginTop: 48 }}>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
          {["拡張子表示", "Bluetooth", "マイク許可", "画面の明るさ", "通知オフ"].map((q) => (
            <Link key={q} href={`/search?q=${encodeURIComponent(q)}`} className="filter-chip" style={{
