...
const allAdditional = [
  ...
  // Windows 11 追加候補
  // ============================================================
  { title:"BitLockerでドライブを暗号化する", slug:"bitlocker-encryption", os:"windows11", version:"25H2", category:"security", difficulty:"intermediate", estimate_minutes:10,
  ...
  { title:"リモートデスクトップを設定する", slug:"setup-remote-desktop", os:"windows11", version:"25H2", category:"network", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"電源プランを変更する", slug:"change-power-plan", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"プリンターを追加する", slug:"add-printer", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:5,
  ...
  { title:"Windowsの表示言語を変更する", slug:"change-display-language", os:"windows11", version:"25H2", category:"system", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"コントロールパネルを開く", slug:"open-control-panel", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"WSL（Windows Subsystem for Linux）を有効にする", slug:"enable-wsl", os:"windows11", version:"25H2", category:"system", difficulty:"advanced", estimate_minutes:10,
  ...
  { title:"スタートメニューにアプリをピン留めする", slug:"pin-to-start", os:"windows11", version:"25H2", category:"app", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"音声入力（ディクテーション）を使う", slug:"use-voice-input", os:"windows11", version:"25H2", category:"input", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"拡大鏡を使う", slug:"use-magnifier", os:"windows11", version:"25H2", category:"accessibility", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"タッチキーボードを設定する", slug:"setup-touch-keyboard", os:"windows11", version:"25H2", category:"input", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Hyper-Vを有効にする", slug:"enable-hyper-v", os:"windows11", version:"25H2", category:"system", difficulty:"advanced", estimate_minutes:5,
  ...
  { title:"レジストリエディタを開く", slug:"open-registry-editor", os:"windows11", version:"25H2", category:"system", difficulty:"advanced", estimate_minutes:1,
  ...
  // iOS 追加候補
  // ============================================================
  { title:"パスコードを変更する", slug:"change-passcode-ios", os:"ios", version:"26", category:"security", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"自動ロックの時間を変更する", slug:"auto-lock-ios", os:"ios", version:"26", category:"display", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"Safariのプライベートブラウズをオンにする", slug:"safari-private-mode-ios", os:"ios", version:"26", category:"privacy", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"iPhoneを探す（Find My）を設定する", slug:"setup-find-my-ios", os:"ios", version:"26", category:"security", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"メディカルIDを設定する", slug:"setup-medical-id-ios", os:"ios", version:"26", category:"security", difficulty:"beginner", estimate_minutes:5,
  ...
  { title:"AssistiveTouchを有効にする", slug:"enable-assistivetouch-ios", os:"ios", version:"26", category:"accessibility", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"文字サイズを変更する", slug:"change-text-size-ios", os:"ios", version:"26", category:"accessibility", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"テキスト置換（定型文）を設定する", slug:"text-replacement-ios", os:"ios", version:"26", category:"input", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"App Storeの自動アップデートをオフにする", slug:"disable-auto-update-ios", os:"ios", version:"26", category:"app", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ショートカットアプリで自動化する", slug:"shortcuts-automation-ios", os:"ios", version:"26", category:"system", difficulty:"intermediate", estimate_minutes:10,
  ...
  // macOS 追加候補
  // ============================================================
  { title:"Gatekeeperのアプリ許可設定をする", slug:"gatekeeper-macos", os:"macos", version:"Tahoe 26", category:"security", difficulty:"intermediate", estimate_minutes:3,
  ...
  { title:"ホットコーナーを設定する", slug:"hot-corners-macos", os:"macos", version:"Tahoe 26", category:"system", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"メニューバーのアイコンを整理する", slug:"menubar-icons-macos", os:"macos", version:"Tahoe 26", category:"display", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Finderでファイルの拡張子を表示する", slug:"show-extensions-macos", os:"macos", version:"Tahoe 26", category:"file", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ターミナルを開く", slug:"open-terminal-macos", os:"macos", version:"Tahoe 26", category:"system", difficulty:"intermediate", estimate_minutes:1,
  ...
  { title:"ディスクユーティリティでディスクを修復する", slug:"disk-utility-repair-macos", os:"macos", version:"Tahoe 26", category:"storage", difficulty:"intermediate", estimate_minutes:10,
  ...
  { title:"カラープロファイルを変更する", slug:"change-color-profile-macos", os:"macos", version:"Tahoe 26", category:"display", difficulty:"intermediate", estimate_minutes:3,
  ...
  { title:"Touch IDを設定する", slug:"setup-touchid-macos", os:"macos", version:"Tahoe 26", category:"security", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"音声入力を有効にする", slug:"enable-voice-input-macos", os:"macos", version:"Tahoe 26", category:"input", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"メールアカウントを追加する", slug:"add-mail-account-macos", os:"macos", version:"Tahoe 26", category:"account", difficulty:"beginner", estimate_minutes:3,
  ...
  // Android
  // ============================================================
  { title:"Wi-Fiに接続する", slug:"connect-wifi-android", os:"android", version:"16", category:"network", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Bluetooth機器を接続する", slug:"connect-bluetooth-android", os:"android", version:"16", category:"bluetooth", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"画面の明るさを変更する", slug:"change-brightness-android", os:"android", version:"16", category:"display", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ナイトライト（ブルーライトカット）を設定する", slug:"night-light-android", os:"android", version:"16", category:"display", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"通知をオフにする", slug:"disable-notifications-android", os:"android", version:"16", category:"notification", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"マイクのアクセスを許可する", slug:"allow-microphone-android", os:"android", version:"16", category:"privacy", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"位置情報をオフにする", slug:"disable-location-android", os:"android", version:"16", category:"privacy", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"バッテリー節約モードをオンにする", slug:"battery-saver-android", os:"android", version:"16", category:"system", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ストレージの使用状況を確認する", slug:"check-storage-android", os:"android", version:"16", category:"storage", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"画面のロックを設定する", slug:"setup-screen-lock-android", os:"android", version:"16", category:"security", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"指紋認証を設定する", slug:"setup-fingerprint-android", os:"android", version:"16", category:"security", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"フォントサイズを変更する", slug:"change-font-size-android", os:"android", version:"16", category:"accessibility", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"着信音を変更する", slug:"change-ringtone-android", os:"android", version:"16", category:"sound", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"デベロッパーオプションを有効にする", slug:"developer-options-android", os:"android", version:"16", category:"system", difficulty:"advanced", estimate_minutes:2,
  ...
  { title:"スクリーンショットを撮る", slug:"take-screenshot-android", os:"android", version:"16", category:"system", difficulty:"beginner", estimate_minutes:1,
