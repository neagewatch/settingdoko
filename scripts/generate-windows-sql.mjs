...
const windowsSettings = [
  // === セキュリティ ===
  { title:"Windowsセキュリティを開く", slug:"open-windows-security", os:"windows11", version:"25H2", category:"security", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ウイルススキャンを実行する", slug:"windows-defender-scan", os:"windows11", version:"25H2", category:"security", difficulty:"beginner", estimate_minutes:5,
  ...
  { title:"Windowsファイアウォールを有効にする", slug:"enable-firewall", os:"windows11", version:"25H2", category:"security", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Windowsロック画面を設定する", slug:"setup-lock-screen", os:"windows11", version:"25H2", category:"security", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"自動ロックの時間を設定する", slug:"auto-lock-setting", os:"windows11", version:"25H2", category:"security", difficulty:"beginner", estimate_minutes:2,
  ...
  // === アカウント ===
  { title:"Microsoftアカウントでサインインする", slug:"signin-microsoft-account", os:"windows11", version:"25H2", category:"account", difficulty:"beginner", estimate_minutes:5,
  ...
  { title:"新しいユーザーアカウントを追加する", slug:"add-user-account", os:"windows11", version:"25H2", category:"account", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"Microsoftアカウントのパスワードを変更する", slug:"change-ms-password", os:"windows11", version:"25H2", category:"account", difficulty:"beginner", estimate_minutes:3,
  ...
  // === ネットワーク ===
  { title:"Wi-Fiに接続する", slug:"connect-wifi-windows", os:"windows11", version:"25H2", category:"network", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Wi-Fiが繋がらない時の対処", slug:"wifi-troubleshoot", os:"windows11", version:"25H2", category:"network", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"VPNを設定する", slug:"setup-vpn", os:"windows11", version:"25H2", category:"network", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"機内モードをオン・オフする", slug:"toggle-airplane-mode", os:"windows11", version:"25H2", category:"network", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"プロキシを設定する", slug:"setup-proxy", os:"windows11", version:"25H2", category:"network", difficulty:"advanced", estimate_minutes:5,
  ...
  // === ストレージ ===
  { title:"ディスクのストレージ使用量を確認する", slug:"check-disk-storage", os:"windows11", version:"25H2", category:"storage", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ストレージセンサーで自動クリーンアップする", slug:"storage-sense", os:"windows11", version:"25H2", category:"storage", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"一時ファイルを削除する", slug:"cleanup-temp-files", os:"windows11", version:"25H2", category:"storage", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"ゴミ箱を空にする", slug:"empty-recycle-bin", os:"windows11", version:"25H2", category:"storage", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ドライブのデフラグ・最適化を行う", slug:"defrag-drive", os:"windows11", version:"25H2", category:"storage", difficulty:"intermediate", estimate_minutes:5,
  ...
  // === アクセシビリティ ===
  { title:"テキストのサイズを変更する", slug:"change-text-size", os:"windows11", version:"25H2", category:"accessibility", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"表示スケールを変更する", slug:"change-display-scale", os:"windows11", version:"25H2", category:"accessibility", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"ハイコントラストモードを設定する", slug:"high-contrast-mode", os:"windows11", version:"25H2", category:"accessibility", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"ナレーター（画面読み上げ）を使う", slug:"use-narrator", os:"windows11", version:"25H2", category:"accessibility", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"マウスポインターのサイズと色を変える", slug:"change-mouse-pointer", os:"windows11", version:"25H2", category:"accessibility", difficulty:"beginner", estimate_minutes:2,
  ...
  // === システム ===
  { title:"タスクマネージャーを開く", slug:"open-task-manager", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"パソコンを再起動する", slug:"restart-pc", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"パソコンをシャットダウンする", slug:"shutdown-pc", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"高速スタートアップを無効にする", slug:"disable-fast-startup", os:"windows11", version:"25H2", category:"system", difficulty:"intermediate", estimate_minutes:3,
  ...
  { title:"仮想デスクトップを使う", slug:"virtual-desktop", os:"windows11", version:"25H2", category:"system", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"コマンドプロンプトを管理者として開く", slug:"open-cmd-admin", os:"windows11", version:"25H2", category:"system", difficulty:"intermediate", estimate_minutes:1,
  ...
  { title:"Windowsの回復・リセットをする", slug:"reset-windows", os:"windows11", version:"25H2", category:"system", difficulty:"advanced", estimate_minutes:30,
  ...
  // === ファイル ===
  { title:"ファイルのコピー・移動をする", slug:"copy-move-files", os:"windows11", version:"25H2", category:"file", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"新しいフォルダを作成する", slug:"create-new-folder", os:"windows11", version:"25H2", category:"file", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ファイルを圧縮・解凍する", slug:"zip-unzip-files", os:"windows11", version:"25H2", category:"file", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"ファイルの検索をする", slug:"search-files", os:"windows11", version:"25H2", category:"file", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"ファイルの関連付けを変更する", slug:"change-file-association", os:"windows11", version:"25H2", category:"file", difficulty:"intermediate", estimate_minutes:3,
  ...
  { title:"OneDriveの同期を設定する", slug:"setup-onedrive", os:"windows11", version:"25H2", category:"file", difficulty:"beginner", estimate_minutes:5,
  ...
  // === 入力・キーボード ===
  { title:"キーボードショートカット一覧", slug:"keyboard-shortcuts", os:"windows11", version:"25H2", category:"input", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"マウスのスクロール速度を変更する", slug:"change-scroll-speed", os:"windows11", version:"25H2", category:"input", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"タッチパッドの感度を変更する", slug:"change-touchpad-sensitivity", os:"windows11", version:"25H2", category:"input", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"日本語入力（IME）の設定を変更する", slug:"change-ime-settings", os:"windows11", version:"25H2", category:"input", difficulty:"intermediate", estimate_minutes:3,
  ...
  // === 表示・個人用設定 ===
  { title:"ダークモードを有効にする", slug:"enable-dark-mode", os:"windows11", version:"25H2", category:"display", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"アクセントカラーを変更する", slug:"change-accent-color", os:"windows11", version:"25H2", category:"display", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"複数ディスプレイを設定する", slug:"setup-multi-display", os:"windows11", version:"25H2", category:"display", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"スクリーンショットを撮る", slug:"take-screenshot", os:"windows11", version:"25H2", category:"display", difficulty:"beginner", estimate_minutes:1,
  ...
  // === プライバシー ===
  { title:"位置情報サービスをオフにする", slug:"disable-location-windows", os:"windows11", version:"25H2", category:"privacy", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"アプリの通知許可を管理する", slug:"manage-app-notifications", os:"windows11", version:"25H2", category:"notification", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"フォーカスアシスト（集中モード）を設定する", slug:"focus-assist", os:"windows11", version:"25H2", category:"notification", difficulty:"beginner", estimate_minutes:2,
  ...
  // === サウンド ===
  { title:"マイクの音量を調整する", slug:"adjust-microphone-volume", os:"windows11", version:"25H2", category:"sound", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"サウンドの出力デバイスをアプリごとに設定する", slug:"app-volume-settings", os:"windows11", version:"25H2", category:"sound", difficulty:"intermediate", estimate_minutes:3,
  ...
  { title:"システムサウンドをオフにする", slug:"disable-system-sounds", os:"windows11", version:"25H2", category:"sound", difficulty:"beginner", estimate_minutes:2,
  ...
  // === アプリ ===
  { title:"Windowsの標準アプリをアンインストールする", slug:"uninstall-builtin-apps", os:"windows11", version:"25H2", category:"app", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Microsoft Storeからアプリをインストールする", slug:"install-from-store", os:"windows11", version:"25H2", category:"app", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"アプリのバックグラウンド実行を制限する", slug:"limit-background-apps", os:"windows11", version:"25H2", category:"app", difficulty:"intermediate", estimate_minutes:3,
...
function pgJsonb(arr) { return `'${JSON.stringify(arr || []).replace(/'/g,"''")}'::jsonb`; }
...
const rows = windowsSettings.map((s,i) => {
  return `  -- ${i+1}. ${s.title}\n  (${pgStr(s.title)},${pgStr(s.slug)},${pgStr(s.os)},${pgStr(s.version)},${pgStr(s.category)},${pgStr(s.difficulty)},${s.estimate_minutes||"NULL"},${pgArr(s.aliases)},${pgArr(s.path)},${pgJsonb(s.steps)},${pgArr(s.related_slugs)},${pgArr(s.keywords)},${pgStr(s.description)})`;
});
