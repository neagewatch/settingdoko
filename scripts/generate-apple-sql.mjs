...
const appleSettings = [
  // ===== macOS =====
  { title:"AirDropで写真やファイルを共有する", slug:"airdrop-macos", os:"macos", version:"Tahoe 26", category:"network", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Time Machineでバックアップを取る", slug:"time-machine-macos", os:"macos", version:"Tahoe 26", category:"storage", difficulty:"beginner", estimate_minutes:5,
  ...
  { title:"FileVaultでディスクを暗号化する", slug:"filevault-macos", os:"macos", version:"Tahoe 26", category:"security", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"Handoffで作業を引き継ぐ", slug:"handoff-macos", os:"macos", version:"Tahoe 26", category:"system", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"スクリーンタイムを設定する", slug:"screen-time-macos", os:"macos", version:"Tahoe 26", category:"system", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"デフォルトブラウザを変更する", slug:"change-default-browser-macos", os:"macos", version:"Tahoe 26", category:"app", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"通知センターをカスタマイズする", slug:"notification-center-macos", os:"macos", version:"Tahoe 26", category:"notification", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"ファインダーの表示を変更する", slug:"finder-view-macos", os:"macos", version:"Tahoe 26", category:"file", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"Macをスリープしないようにする", slug:"prevent-sleep-macos", os:"macos", version:"Tahoe 26", category:"system", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"キーボードのショートカットをカスタマイズする", slug:"custom-shortcuts-macos", os:"macos", version:"Tahoe 26", category:"input", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"iCloud Driveを設定する", slug:"icloud-drive-macos", os:"macos", version:"Tahoe 26", category:"storage", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"Macのパスワードを変更する", slug:"change-password-macos", os:"macos", version:"Tahoe 26", category:"security", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"Wi-Fiのパスワードを確認する", slug:"check-wifi-password-macos", os:"macos", version:"Tahoe 26", category:"network", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Macのストレージを最適化する", slug:"optimize-storage-macos", os:"macos", version:"Tahoe 26", category:"storage", difficulty:"beginner", estimate_minutes:3,
  ...
  // ===== iOS =====
  { title:"AirDropで写真やファイルを共有する", slug:"airdrop-ios", os:"ios", version:"26", category:"network", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"バッテリー残量を％で表示する", slug:"battery-percentage-ios", os:"ios", version:"26", category:"display", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"低電力モードをオンにする", slug:"battery-save-ios", os:"ios", version:"26", category:"system", difficulty:"beginner", estimate_minutes:1,
  ...
  { title:"iCloudのバックアップを設定する", slug:"icloud-backup-ios", os:"ios", version:"26", category:"storage", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"Siriを設定する", slug:"setup-siri-ios", os:"ios", version:"26", category:"system", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"集中モード（フォーカス）を設定する", slug:"focus-mode-ios", os:"ios", version:"26", category:"notification", difficulty:"intermediate", estimate_minutes:5,
  ...
  { title:"コントロールセンターをカスタマイズする", slug:"control-center-ios", os:"ios", version:"26", category:"system", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"アプリのアクセス権限をまとめて確認する", slug:"check-app-permissions-ios", os:"ios", version:"26", category:"privacy", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"Wi-Fiのパスワードを確認する", slug:"check-wifi-password-ios", os:"ios", version:"26", category:"network", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"写真のアルバムを整理する", slug:"organize-photos-ios", os:"ios", version:"26", category:"app", difficulty:"beginner", estimate_minutes:3,
  ...
  { title:"着信音・通知音を変更する", slug:"change-ringtone-ios", os:"ios", version:"26", category:"sound", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"Appライブラリを使う", slug:"app-library-ios", os:"ios", version:"26", category:"app", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"緊急SOSを設定する", slug:"emergency-sos-ios", os:"ios", version:"26", category:"security", difficulty:"beginner", estimate_minutes:2,
  ...
  { title:"ホーム画面をカスタマイズする", slug:"customize-homescreen-ios", os:"ios", version:"26", category:"display", difficulty:"beginner", estimate_minutes:5,
